...
describe('The Object API Search Function', () => {
    describe('The infrastructure', () => {
        ...
        it('provides each providers results as promises that resolve in parallel', async () => {
            ...
            const anotherMockProviderStart =
                anotherMockProviderResults.start.getTime();
            const anotherMockProviderEnd =
                anotherMockProviderResults.end.getTime();
    ...
    describe('The in-memory search indexer', () => {
        ...
        beforeEach((done) => {
            ...
            spyOn(
                openmct.objects.inMemorySearchProvider,
                'search'
            ).and.callThrough();
            spyOn(
                openmct.objects.inMemorySearchProvider,
                'localSearchForObjects'
            ).and.callThrough();
        ...
        it('can provide indexing without a provider', () => {
            openmct.objects.search('foo');
            expect(
                openmct.objects.inMemorySearchProvider.search
            ).toHaveBeenCalled();
        });
        ...
        describe('Without Shared Workers', () => {
            ...
            it('calls local search', () => {
                openmct.objects.search('foo');
                expect(
                    openmct.objects.inMemorySearchProvider.localSearchForObjects
                ).toHaveBeenCalled();
            });
