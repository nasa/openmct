...
import LegacyTelemetryProvider from './runs/LegacyTelemetryProvider';
import RegisterLegacyTypes from './runs/RegisterLegacyTypes';
import LegacyObjectAPIInterceptor from './services/LegacyObjectAPIInterceptor';
import installLegacyViews from './views/installLegacyViews';
import legacyCompositionPolicyAdapter from './policies/LegacyCompositionPolicyAdapter';
import LegacyActionAdapter from './actions/LegacyActionAdapter';
import LegacyPersistenceAdapter from './services/LegacyPersistenceAdapter';
