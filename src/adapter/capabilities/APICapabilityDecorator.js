...
define([
     ...
     * and new API.
     */
    class APICapabilityDecorator {
      constructor($injector, capabilityService) {
        this.$injector = $injector;
        this.capabilityService = capabilityService;
    }

    getCapabilities(model) {
        let capabilities = this.capabilityService.getCapabilities(model);
        ...
        if (AlternateCompositionCapability.appliesTo(model)) {
            capabilities.composition = (domainObject) => {
