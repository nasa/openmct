...
describe('the plugin', function () {
    ...
    describe('the condition check for staleness', () => {
        ...
        fit('should evaluate as stale when telemetry is not received in the allotted time', (done) => {
        ...
        fit('should not evaluate as stale when telemetry is received in the allotted time', (done) => {
            const date = Date.now();
