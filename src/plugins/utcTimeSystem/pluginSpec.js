...
describe('The UTC Time System', () => {
    ...
    describe('plugin', function () {
        ...
        it('is installed', () => {
            ...
            let utc = timeSystems.find(
                (ts) => ts.key === UTC_SYSTEM_AND_FORMAT_KEY
            );
        ...
        it('can be set to be the main time system', () => {
            ...
            expect(openmct.time.timeSystem().key).toBe(
                UTC_SYSTEM_AND_FORMAT_KEY
            );
        });
    ...
    describe('UTC Time Format', () => {
        ...
        beforeEach(() => {
            utcTimeFormatter = openmct.telemetry.getFormatter(
                UTC_SYSTEM_AND_FORMAT_KEY
            );
        });
    ...
    describe('Duration Format', () => {
        ...
        beforeEach(() => {
            durationTimeFormatter =
                openmct.telemetry.getFormatter(DURATION_FORMAT_KEY);
        });
