...
describe('The Clear Data Plugin:', () => {
    ...
    describe('The clear data action:', () => {
        ...
        it('is applicable on applicable objects', () => {
            const gatheredActions =
                openmct.actions.getActionsCollection(mockObjectPath);
            expect(
                gatheredActions.applicableActions['clear-data-action']
            ).toBeDefined();
        });
    ...
    describe('The clear data indicator:', () => {
        ...
        it('installs', () => {
            const globalClearIndicator =
                openmct.indicators.indicatorObjects.find(
