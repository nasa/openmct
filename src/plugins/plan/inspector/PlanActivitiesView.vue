...
<div class="c-inspector__properties c-inspect-properties">
    <plan-activity-view v-for="(activity, index) in activities"
                        ...
                        :heading="heading"
    />
    <!-- If two or more Activities are selected -->
    ...
    <!--    <template v-if="true">-->
    <!--        &lt;!&ndash; If one or more properties exist for selected activities &ndash;&gt;-->
    <!--        <div class="c-inspect-properties__header">-->
    <!--            Properties-->
    <!--        </div>-->
    <!--        <ul class="c-inspect-properties__section">-->
    ...
    <!--    <template v-if="true">-->
    <!--        &lt;!&ndash; If one or more links exist for selected activities &ndash;&gt;-->
    <!--        <div class="c-inspect-properties__header">-->
    <!--            Links-->
    <!--        </div>-->
    <!--        <ul class="c-inspect-properties__section">-->
