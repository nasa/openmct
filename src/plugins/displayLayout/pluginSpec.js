...
describe('the plugin', function () {
    ...
    it('defines a display layout object type with the correct key', () => {
        expect(displayLayoutDefinition.definition.name).toEqual(
            'Display Layout'
        );
    });
    ...
    describe('the alpha numeric format view', () => {
                ...
                [
                    {
                        context: {
                            layoutItem:
                                displayLayoutItem.configuration.items[0],
                            item: telemetryItem,
                            index: 1
                        }
                    },
        ...
        it('provides an alphanumeric format view', () => {
            const displayLayoutAlphaNumFormatView =
                openmct.inspectorViews.get(selection);
                ...
                [
                    {
                        context: {
                            layoutItem:
                                displayLayoutItem.configuration.items[1],
                            index: 1
                        }
                    },
                    {
                ...
                [
                    {
                        context: {
                            layoutItem:
                                displayLayoutItem.configuration.items[2],
                ...
                [
                    {
                        context: {
                            ...
                            layoutItem:
                                displayLayoutItem.configuration.items[3],
                            index: 3
                        }
                    },
                    {
