...
define([
   ...
   */
   class MCT extends EventEmitter {
     constructor(legacyRegistry) {
       super();
     ...
     */
     ...
     legacyExtension(category, extension) {
     ...
     */
     start(domElement) {
       ...
       this.types.listKeys().forEach( (typeKey) => {
         let type = this.types.get(typeKey);
         let legacyDefinition = type.toLegacyDefinition();
