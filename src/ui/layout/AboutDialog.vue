    ...
    <div class="c-about__text s-text">
        ...
        <div class="c-about__text__element">
            ...
            <div class="l-description s-description">
                <p>Open MCT, Copyright &copy; 2014-2023, United States Government as represented by the Administrator of the National Aeronautics and Space Administration. All rights reserved.</p>
                <p>
