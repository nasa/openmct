...
test.describe('Snapshot Menu tests', () => {
    ...
    test.fixme(
        'Can add Snapshots via Snapshot Menu and details are correct',
        async ({ page }) => {
...
test.describe('Snapshot Container tests', () => {
    test.beforeEach(async ({ page }) => {
        ...
        await page
            .getByRole('menuitem', { name: ' Save to Notebook Snapshots' })
            .click();
        await page.getByRole('button', { name: 'Show' }).click();
    });
    test.fixme(
        '5 Snapshots can be added to a container',
        async ({ page }) => {}
    );
    test.fixme(
    ...
    test.fixme(
        ...
        async ({ page }) => {
            await page
                .locator('.c-snapshot.c-ne__embed')
                .first()
                .getByTitle('More options')
                .click();
            await page
                .getByRole('menuitem', { name: ' View Snapshot' })
                .click();
    ...
    test('A snapshot can be Quick Viewed from Container with 3 dot action menu', async ({
        page
    }) => {
        await page
            .locator('.c-snapshot.c-ne__embed')
    ...
    test.fixme(
        'A snapshot Container can be open and closed',
        async ({ page }) => {}
    );
    test.fixme(
