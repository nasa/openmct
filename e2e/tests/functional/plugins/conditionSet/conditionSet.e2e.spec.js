...
test.describe.serial('Condition Set CRUD Operations on @localStorage', () => {
    ...
    test('condition set object can be modified on @localStorage', async ({ page, openmctConfig }) => {
        ...
        await page.locator('span').filter({ hasText: 'Unnamed Condition Set' }).first().fill('Renamed Condition Set');
        await page.locator('span').filter({ hasText: 'Unnamed Condition Set' }).first().press('Enter');
        // Click Save Button
