...
async function createClockAndDisplayLayout(page) {
    ...
    await Promise.all([
        page.waitForNavigation(/*{ url: 'http://localhost:8080/#/browse/mine?tc.mode=fixed&tc.startBound=1656414498786&tc.endBound=1656416298786&tc.timeSystem=utc' }*/),
...
test.describe('Grand Search', () => {
    test('Can search for objects, and subsequent search dropdown behaves properly', async ({ page }) => {
        ...
        await percySnapshot('Searching for Clocks');
