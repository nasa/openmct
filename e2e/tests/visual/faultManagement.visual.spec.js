...
test.describe('The Fault Management Plugin Visual Test', () => {
    test('icon test', async ({ page, theme }) => {
        ...
        await percySnapshot(
            page,
            `Fault Management icon appears in tree (theme: '${theme}')`
        );
    });
    ...
    test('fault list and acknowledged faults', async ({ page, theme }) => {
        ...
        await percySnapshot(
            page,
            `Shows a list of faults in the standard view (theme: '${theme}')`
        );
    ...
    test('shelved faults', async ({ page, theme }) => {
        ...
        await percySnapshot(
            page,
            `Shelved faults appear in the shelved view (theme: '${theme}')`
        );
