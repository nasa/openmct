...
test.describe('The Fault Management Plugin using example faults', () => {
    ...
    test('Shows a criticality icon for every fault', async ({ page, theme }) => {
...
test.describe('The Fault Management Plugin using example faults', () => {
    ...
    test('When selecting a fault, it has an "is-selected" class and it\'s information shows in the inspector', async ({ page, theme }) => {
    ...
    test('When selecting multiple faults, no specific fault information is shown in the inspector', async ({ page, theme }) => {
        await selectFaultItem(page, 1);
    ...
    test('Allows you to shelve a fault', async ({ page, theme }) => {
    ...
    test('Allows you to acknowledge a fault', async ({ page, theme }) => {
    ...
    test('Allows you to shelve multiple faults', async ({ page, theme }) => {
    ...
    test('Allows you to acknowledge multiple faults', async ({ page, theme }) => {
    ...
    test('Allows you to search faults', async ({ page, theme }) => {
    ...
    test('Allows you to sort faults', async ({ page, theme }) => {
