...
test.describe('Visual - Default', () => {
    ...
    test('Visual - Default Condition Set @unstable', async ({
        page,
        theme
    }) => {
    ...
    test('Visual - Default Condition Widget @unstable', async ({
        page,
        theme
    }) => {
        ...
        await percySnapshot(
            page,
            `Default Condition Widget (theme: '${theme}')`
        );
    });

    test('Visual - Time Conductor start time is less than end time', async ({
        page,
        theme
    }) => {
    ...
    test('Visual - Sine Wave Generator Form', async ({ page, theme }) => {
        ...
        await percySnapshot(
            page,
            `Default Sine Wave Generator Form (theme: '${theme}')`
        );
        ...
        await percySnapshot(
            page,
            `removed amplitude property value (theme: '${theme}')`
        );
    });

    test('Visual - Save Successful Banner @unstable', async ({
        page,
        theme
    }) => {
    ...
    test('Visual - Display Layout Icon is correct', async ({ page, theme }) => {
        ...
        await percySnapshot(
            page,
            `Display Layout Create Menu (theme: '${theme}')`
        );
    });

    test('Visual - Default Gauge is correct @unstable', async ({
        page,
        theme
    }) => {
