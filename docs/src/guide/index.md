...
 
  The bundle definition is the main point of entry for the bundle. The framework looks at 
...
 
 ● implementation​: Identifies a JavaScript source file (in the sources folder) which 
